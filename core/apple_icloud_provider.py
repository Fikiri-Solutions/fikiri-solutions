...
class AppleiCloudProvider:
    ...
    def generate_jwt_token(self) -> str:
        ...
        try:
            ...
            print(f"❌ Failed to generate Apple JWT token: {e}")
            return None
    ...
    def authenticate(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print("✅ Apple iCloud Mail authentication successful")
                return True
            else:
                print(f"❌ Apple iCloud Mail authentication failed: {response.status_code}")
                return False
                
        except Exception as e:
            print(f"❌ Apple iCloud Mail authentication error: {e}")
            return False
    ...
    def get_messages(self, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"✅ Retrieved {len(messages)} messages from Apple iCloud")
            return messages
            
        except Exception as e:
            print(f"❌ Failed to get Apple iCloud messages: {e}")
            return []
    ...
    def send_message(self, to: str, subject: str, body: str) -> bool:
        ...
        try:
            ...
            print(f"✅ Message sent via Apple iCloud to {to}")
            return True
            
        except Exception as e:
            print(f"❌ Failed to send Apple iCloud message: {e}")
            return False
    ...
    def get_contacts(self, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"✅ Retrieved {len(contacts)} contacts from Apple iCloud")
            return contacts
            
        except Exception as e:
            print(f"❌ Failed to get Apple iCloud contacts: {e}")
            return []
    ...
    def get_calendar_events(self, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"✅ Retrieved {len(events)} calendar events from Apple iCloud")
            return events
            
        except Exception as e:
            print(f"❌ Failed to get Apple iCloud calendar events: {e}")
            return []
    ...
    def create_calendar_event(self, subject: str, start_time: str, end_time: str,
        ...
        try:
            ...
            print(f"✅ Calendar event created via Apple iCloud: {subject}")
            return True
            
        except Exception as e:
            print(f"❌ Failed to create Apple iCloud calendar event: {e}")
            return False
    ...
    def get_user_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"❌ Failed to get Apple iCloud user info: {e}")
            return {}
...
if __name__ == "__main__":
    ...
    if provider.authenticate():
        print("✅ Apple iCloud provider authenticated successfully")
        ...
        print("❌ Apple iCloud provider authentication failed")
