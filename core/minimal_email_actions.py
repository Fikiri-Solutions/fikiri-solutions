    ...
    def process_email(self, parsed_email: Dict[str, Any], action_type: str = "auto_reply", 
        ...
        try:
            ...
            if action_type == "auto_reply":
                result = self._auto_reply(parsed_email, user_id)
            elif action_type == "mark_read":
                result = self._mark_read(parsed_email, user_id)
            elif action_type == "add_label":
                result = self._add_label(parsed_email, user_id)
            elif action_type == "forward":
                result = self._forward_email(parsed_email, user_id)
            elif action_type == "archive":
                result = self._archive_email(parsed_email, user_id)
            else:
            ...
            self._persist_action_log(error_result)
            return error_result
