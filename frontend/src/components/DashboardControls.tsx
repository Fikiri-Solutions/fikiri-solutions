      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <Calendar className="h-4 w-4 text-gray-500 dark:text-gray-400" aria-hidden />
            <label htmlFor="dashboard-activity-period" className="sr-only">
              Activity chart period
            </label>
            <select
              id="dashboard-activity-period"
        ...
        {showFilters && (
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* Status Filter */}
              <div>
                <label htmlFor="dashboard-status-filter" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Status
                </label>
                <select
              ...
              {/* Type Filter */}
              <div>
                <label htmlFor="dashboard-type-filter" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Type
                </label>
                <select
