...
export const config = {
  ...
  version: '1.0.13', // Force deployment refresh - error fix
  buildTimestamp: '2025-09-25T19:10:00Z', // Force cache refresh
  cacheVersion: 'v1.0.13-20250925', // Force cache refresh
