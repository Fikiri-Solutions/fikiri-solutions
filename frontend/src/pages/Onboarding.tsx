...
export const Onboarding: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // First update the onboarding step to 4 (completion)
      const stepResponse = await fetch('http://localhost:5000/api/user/onboarding-step', {
        method: 'PUT',
        headers: {
      ...
      if (!stepResponse.ok) {
        console.warn('Failed to update onboarding step, continuing with completion...');
      }

      // Then save the onboarding data
