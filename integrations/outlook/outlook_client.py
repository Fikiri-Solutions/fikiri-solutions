...
class MicrosoftGraphProvider:
    ...
    def refresh_access_token(self) -> bool:
        ...
        try:
            ...
            logger.error("Microsoft Graph token refresh failed: %s", e)
            return False
    ...
    def get_messages(self, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.info("Retrieved %s messages from Microsoft Graph", len(messages))
            return messages
            
        except Exception as e:
            logger.error("Failed to get Microsoft Graph messages: %s", e)
            return []
    ...
    def send_message(self, to: str, subject: str, body: str) -> bool:
        ...
        try:
            ...
            logger.info("Message sent via Microsoft Graph to %s", to)
            return True
            
        except Exception as e:
            logger.error("Failed to send Microsoft Graph message: %s", e)
            return False
    ...
    def get_calendar_events(self, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.info("Retrieved %s calendar events from Microsoft Graph", len(events))
            return events
            
        except Exception as e:
            logger.error("Failed to get Microsoft Graph calendar events: %s", e)
            return []
    ...
    def get_contacts(self, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.info("Retrieved %s contacts from Microsoft Graph", len(contacts))
            return contacts
            
        except Exception as e:
            logger.error("Failed to get Microsoft Graph contacts: %s", e)
            return []
    ...
    def create_calendar_event(self, subject: str, start_time: str, end_time: str, 
        ...
        try:
            ...
            logger.info("Calendar event created via Microsoft Graph: %s", subject)
            return True
            
        except Exception as e:
            logger.error("Failed to create Microsoft Graph calendar event: %s", e)
            return False
    ...
    def get_user_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("Failed to get Microsoft Graph user info: %s", e)
            return {}
...
if __name__ == "__main__":
    ...
    if provider.authenticate():
        logger.info("Microsoft Graph provider authenticated successfully")
        ...
        logger.error("Microsoft Graph provider authentication failed. Check configuration and try again.")
